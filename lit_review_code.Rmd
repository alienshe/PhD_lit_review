...
scop_26_6_first_pass|>filter(grepl("unclear method",TAGS))
...
master_db[(master_db$URL %in% include_unclear_method$URL),]$INCLUSION<-"Include"
master_db[(master_db$URL %in% exclude_unclear_method$URL),]$INCLUSION<-"Exclude"
